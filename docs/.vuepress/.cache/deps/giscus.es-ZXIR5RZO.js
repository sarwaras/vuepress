...
// node_modules/@giscus/vue/dist/giscus.es.js
...
var o$5 = (t2) => new s$3(typeof t2 == "string" ? t2 : t2 + "", e$6);
var r$4 = (t2, ...n2) => {
...
var S$1 = t$2 ? (t2) => t2 : (t2) => t2 instanceof CSSStyleSheet ? ((t3) => {
  let e2 = "";
...
var r$3 = e$5 ? e$5.emptyScript : "";
var h$3 = window.reactiveElementPolyfillSupport;
var o$4 = { toAttribute(t2, i2) {
  switch (i2) {
    case Boolean:
      t2 = t2 ? r$3 : null;
      break;
...
var n$6 = (t2, i2) => i2 !== t2 && (i2 == i2 || t2 == t2);
var l$3 = { attribute: true, type: String, converter: o$4, reflect: false, hasChanged: n$6 };
...
var e$4 = `lit$${(Math.random() + "").slice(9)}$`;
var o$3 = "?" + e$4;
var n$5 = `<${o$3}>`;
var l$2 = document;
...
var n$3 = (n2) => (e2) => typeof e2 == "function" ? ((n3, e3) => (window.customElements.define(n3, e3), e3))(n2, e2) : ((n3, e3) => {
  const { kind: t2, elements: i2 } = e3;
  return { kind: t2, elements: i2, finisher(e4) {
    window.customElements.define(n3, e4);
  } };
})(n2, e2);
var i$1 = (i2, e2) => e2.kind === "method" && e2.descriptor && !("value" in e2.descriptor) ? { ...e2, finisher(n2) {
...
var GiscusWidget = class extends s {
  constructor() {
    super();
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=giscus.es-ZXIR5RZO.js.map
